...
}(window, document, "script", "https://www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-17692414-10", "auto"), ga("send", "pageview"), $(document).keypress(function(e) {
    var t = e ? e : window.event;
    (32 === t.keyCode || 32 === t.charCode) && (1 != front_player.getPlayerState() ? (front_player.playVideo(), showVisual(), vtime.resume()) : (front_player.pauseVideo(), hideVisual(), vtime.pause())), (13 === t.keyCode || 13 === t.charCode) && getNextSong(currentSong)
});