...
var front_player, BASE_FINDERS = " lyrics -karaoke -soundtrack -glee -cover ",
...
successCallback = function(e) {
    if (e) {
        ...
        o.length > 10 && (console.log("ALREADY PLAYED: " + t), t = e.items[1].snippet.title, n = e.items[1].id.videoId), t = t.replace(/with lyrics/gi, ""), t = t.replace(/\(lyrics\)/gi, ""), t = t.replace(/lyrics/gi, ""), t = t.replace(/lyric/gi, ""), t = t.replace(/w\//gi, ""),
