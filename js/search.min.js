...
var loopSong = function(e) {
    if (LOOP_ON) {
        $("img.loop").attr("src", "media/svg/infoff.png");
        LOOP_ON = false;
    } else {
        $("img.loop").attr("src", "media/svg/infon.png");
        LOOP_ON = true;
    }
}
...
var front_player, BASE_FINDERS = " lyrics -kids -kidzbop -minecraft -pranking",
    PRE = '<span class="pre status">Now playing...</span><br>',
    POST = '<span class="pre"><br>' +
    '<img class="loop" src="media/svg/infoff.png" onclick="loopSong(currentSong)"/>' +
